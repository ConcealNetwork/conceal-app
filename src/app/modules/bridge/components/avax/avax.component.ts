...
export class AvaxSwapComponent implements OnInit, OnDestroy {
  ...
  constructor (
	...
	addToken(e:Event) {
		...
		e.preventDefault();
		e.stopPropagation();
		this.ethersService.addWCCXToken('0xF1d58805638639E08d34689415d35d129e153B6B');
	}
	...
	addCustomChains() {
		...
		let symbol = 'AVAX';
		let decimals = 18;
		let rpcUrls = 'https://api.avax.network/ext/bc/C/rpc';
		let blockExplorerUrls = 'https://snowtrace.io';
